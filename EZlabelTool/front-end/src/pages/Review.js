...
import { LeftOutlined, RightOutlined, AimOutlined, HomeOutlined, BorderOutlined, StarOutlined} from '@ant-design/icons';
...
export default function App(props) {
  ...
  const handleNextImage = () => {
    ...
    HttpUtil.post(ApiUtil.API_REVIEW_NEXT, values)
      .then(
        re => {
          handleChooseImage();
        }
  ...
  const handleChooseImage = () => {
    ...
    HttpUtil.post(ApiUtil.API_REVIEW_CHOOSE, json_info)
      .then((result) => {
        if (result.code === 0) {
