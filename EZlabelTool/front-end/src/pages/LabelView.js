...
import { LeftOutlined, BulbOutlined, AimOutlined, HomeOutlined, BorderOutlined, StarOutlined } from '@ant-design/icons';
...
export default function App(props) {
  ...
  const handleChooseImage = () => {
    ...
    HttpUtil.post(ApiUtil.API_IMAGE_VIEW_CHOOSE, json_info)
      .then((result) => {
        if (result.code === 0) {
